                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Data Siswa</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <table id="example" class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo site_url('admin/update_siswa/' . $u->nis); ?>"
                                                        class="btn btn-info">Update</a>

                                                    <a href="<?php echo site_url('admin/delete_siswa/' . $u->nis); ?>"
