            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="menu-header">Kelola Siswa</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-user"></i>
                                <span>Siswa</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?=base_url('admin/data_siswa')?>">Data Siswa</a></li>
                                <li><a class="nav-link" href="<?=base_url('admin/add_siswa')?>">Tambah Data Siswa</a></li>
                            </ul>
                        </li>
                        <li class="menu-header">Kelola Guru</li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="menu-header">Kelola Informasi</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-info"></i>
                                <span>Informasi</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?=base_url('admin/data_informasi')?>">Data Informasi</a>
                                </li>
                                <li><a class="nav-link" href="<?=base_url('admin/add_informasi')?>">Tambah Data Informasi</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-header">Kelola Tahun Ajaran</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-calendar"></i>
                                <span>Tahun Ajaran</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?=base_url('admin/data_tahunajaran')?>">Tahun Ajaran</a>
                                </li>
                                <li><a class="nav-link" href="<?=base_url('admin/add_tahunajaran')?>">Tambah Tahun Ajaran</a>
                                </li>
                            </ul>
                        </li>
                </aside>
