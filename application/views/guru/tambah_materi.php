                        ...
                        <div class="card card-success">
                            ...
                            <div id="detail" class="card-body">
                                <form method="POST" enctype="multipart/form-data"
                                    action="<?=base_url('guru/tambah_materi')?>">
                                    <div class="col-md-12 bg-white"
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select required id="inputState" name="id_tahunajaran" class="form-control">
                                                    <option selected>Pilih disini</option>
                                                    <?php
                                                        foreach ($user as $u) {
                                                            ?>
                                                    <option value="<?php echo $u->id_tahunajaran ?>"><?php echo $u->tahun_ajaran ?></option>
                                                    <?php
                                                        }
                                                        ?>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label for="inputState">Kurikulum</label>
                                                <select required id="inputState" name="kurikulum" class="form-control">
                                                    <option selected>Pilih disini</option>
                                                    <option value="Kurikulum 2013">Kurikulum 2013</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">ID Materi</label>
