    ...
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url('guru/detail_materi/' . $u->id_materi); ?>"
                                                    class="btn btn-success">Detail</a>
                                            </td>

                                            <td class="text-center">
                                                <a href="<?php echo site_url('guru/update_materi/' . $u->id_materi); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('guru/delete_materi/' . $u->id_materi); ?>"
