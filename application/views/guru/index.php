            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Beranda Guru</h1>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <?php echo $this->db->count_all('evaluasi'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="hero text-white hero-bg-image"
                            ...
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                        ...
                                                        ?>!</h1>
                                <p class="lead">Di halaman guru - Web Edukasi SMP PGRI Dago Pakar<br></p>
                                <div class="mt-4">
