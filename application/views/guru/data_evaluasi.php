                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Evaluasi Materi</h2>
                                ...
                                <table id="example" class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr class="text-center">
                                            <th scope="col">ID</th>
                                            <th scope="col">Jenis Evaluasi</th>
...
foreach ($user as $u) {
    ?>
                                        <tr class="text-center">
                                            ...
                                            <th scope="row">
                                                <?php echo $u->id_evaluasi ?>
                                            </th>

                                            <td>
                                                <?php echo $u->jenis_evaluasi ?>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url('guru/detail_evaluasi/' . $u->id_evaluasi); ?>"
